      ...
      <div className={flex({ direction: 'column', w: '100%', maxW: '1080px', gap: '30px'})}>
        ...
        <Section heading="Programming">
          <dl className={css({ "& dd": { paddingLeft: '20px' } })}>
            ...
            <dt>ソフトウェア設計</dt>
            <dd>
              要件定義は経験がないです。機能を定義するような基本設計は、仕事で役割を担ったことはありませんが、足りない場合は都度補って提案してきましたし、個人の開発プロジェクトではそのあたりもしています。<br />
              さらに詳細に入って、ソフトウェア設計については、コーディングレベルのアーキテクチャ、テーブル設計など、一通りできます。また、モデリングについては強い興味を持って仕事しています。<br />
              toBの開発ばかり経験しているので、業務プロセスを設計したり、業務プロセス上でのシステムの最適化は意識しています。
            </dd>
            <dt>フロントエンド</dt>
            <dd>
              Reactは好きで個人でも仕事でも使っていますが、UIデザインはできません。<br />
              ビルドプロセスの内部をチューニング、カスタマイズするような経験はありませんが、最近のビルドツールを使って基本的なビルドプロセスを構築することはできます。<br />
            </dd>
            <dt>インフラ設計</dt>
            <dd>
              サーバを一からセットアップしてネットワークを設計するようなことは知見がありません。AWSやGoogle Cloudの各機能を数点組み合わせて、小さなインフラを設計する程度は個人のプロジェクトでしています。<br />
              AWSやGoogle Cloud上に構築されたインフラを理解し、保守運用、トラブルシューティングは多少の経験があります。<br />
            ...
            <dt>Go</dt>
            <dd>
              Goは最も興味を持っている言語で、基本的には個人のプロジェクトはGoにしています。<br />
              ちょっとしたコードサンプルやスクリプトもGoで記載し、ソフトウェア設計の際にも、Goの言語機能をベースに考える傾向があります。<br />
              ただ、仕事で実務上の経験はありません。<br />
            </dd>
            <dt>JavaScript,TypeScript</dt>
            <dd>
              JavaScriptは好きな言語で、実用上はTypeScriptを利用すべきという考えのもと、UIのある個人のプロジェクトはよく利用します。<br />
        ...
        <Section heading="Engineering">
          ...
          <dl className={css({ "& dd": { paddingLeft: '20px' } })}>
            ...
            <dd>
              ...
              version管理はしていますがversion管理の設計をしたことはありません。また、モノレポ構成の設計、運用は未経験です。<br />
            </dd>
            <dt>プロジェクト、タスク管理</dt>
            <dd>
        ...
        <Section heading="Management">
          ...
          <dl className={css({ "& dd": { paddingLeft: '20px' } })}>
            ...
            <dd>
              ...
              実績だったり貢献度だけではなく、当人にとっての成長などを含めて評価はしたいと思っています。<br />
              評価はエスカレーションしているので、給与を決めるようなプロセスの最終決定に関わったことはありません。<br />
            </dd>
            <dt>面接</dt>
            <dd>
              面接は月に最大10本程度までする時期を経験しています。(他の業務がある状態で)<br />
        ...
        <Section heading="Product">
          <p>
            プロダクトマネジメントという役割は経験がありませんが、プロダクトがどうあるべきかという点は意識し、機能設計は行ってきました。<br />
